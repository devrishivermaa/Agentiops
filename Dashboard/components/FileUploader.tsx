  ...
  return (
    <div className="flex flex-col items-center justify-center h-full max-w-2xl mx-auto p-6">
      <div 
        className={`
          ...
          ${isDragging 
            ...
            : 'border-zinc-700 hover:border-zinc-500 bg-surfaceHighlight/30'
          }
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
        <div className="bg-surfaceHighlight p-4 rounded-lg border border-zinc-800">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-2 h-2 rounded-full bg-blue-500" />
            <span className="font-semibold text-zinc-300">Extract</span>
          </div>
          <p className="text-xs text-zinc-500">Intelligent PDF parsing and sectioning</p>
        </div>
        <div className="bg-surfaceHighlight p-4 rounded-lg border border-zinc-800">
          <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-xs text-zinc-500">Master agent distributes workload strategy</p>
        </div>
        <div className="bg-surfaceHighlight p-4 rounded-lg border border-zinc-800">
          <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-xs text-zinc-500">Workers analyze pages and compile results</p>
        </div>
      </div>
    </div>
  );
